...
| _(impact-modeling, jointly with domain-provenance)_ | `application/preflight/`, `application/extract-constraints/`, `application/build-runtime-topology/`, `domain/preflight`, `domain/constraint`, `domain/runtime` | The adversarial preflight pass (ADR-0017/0021): constraint extraction and checking, runtime walks, findings, plan assessment; constraint semantics changes escalate to product-architecture |
